defmodule MasarykEx.Commands.RestaurantMenus.Restaurants do
  ...
  def list do [
    ...
    %RestaurantDescriptor.Menicka{id: 2752, name: "U Dřeváka Beer&Grill", icon: "🍔", color: 0x7c1c14},
    ...
    %RestaurantDescriptor.Func{
      ...
      color: 0x66ad2d,
      evaluate: fn ->
        emoji = ~r/[\x{1F300}-\x{1FAFF}\x{2600}-\x{27BF}\x{1F1E6}-\x{1F1FF}\x{2B00}-\x{2BFF}\x{FE0F}\x{200D}]/u
